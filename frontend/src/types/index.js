 ...
 * @typedef {{id:string,stationId:string,periodStart:string,periodEnd:string,aquiferArea:number,waterLevelFluctuation:number,specificYield:number,rechargeValue:number,methodology:'WTF',calculatedAt:string}} RechargeCalculation
